...
<div class="container-fluid">
    <div class="row flex-xl-nowrap">
        <div class="col-12 col-md-3 col-xl-2 bd-sidebar">
            ...
            <main class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">
                <h1 class="bd-title" id="content">查看作业</h1>

                <form class="form-inline" action="HomeWorkSelectServlet">
                    <label>日期:</label>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <%
                            ...
                            ArrayList<Homework> a =  hs.getHomework();
                            if (a == null) {
                                a = new ArrayList();
                            }
                        ...
                        <tr>
                            ...
                            <td>
                                <button  type="button" class="btn btn-primary" name="opendetailbtn" id="<%=hw.getId() %>" >
                                    完成情况
                                </button>
                            </td>
                            <td>
                                <button  type="button" class="btn btn-primary" name="openhwdetailbtn" id="<%=hw.getId() %>" >
                                    作业详情
                                </button>
                            </td>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            //ajax
            $("button[name='opendetailbtn']").click(function(){
                var rid=this.id;
                var fmt = SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                $.getJSON("HomeWorkDetailsServlet",{hid:rid},function (json) {
                    $("#dtbodybtn").empty();
                    for(var key in json){
                        $("#dtbodybtn").append("<tr>" +
                            "<td>" +
                            ...
                            "</td>" +
                            "<td>" +
                            fmt.format(json[key].finish_time)+
                            "</td>" +
                            "<td>" +
                            json[key].type+
                            "</td>" +
                            "<td>" +
                            fmt.format(json[key].complete_time)+
                            "</td>" +
                            "<td>" +
                            json[key].status+
                            "</td>" +
            ...
            $("button[name='openhwdetailbtn']").click(function(){
                var rid=this.id;
                var fmt = SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                $.getJSON("HwDetailServlet",{hid:rid},function (json) {
                    $("#hwdtbodybtn").empty();
                    for(var key in json){
                        $("#hwdtbodybtn").append("<tr>" +
                            "<td>" +
                            json[key].id+
                            "</td>" +
                            "<td>" +
