        ...
        <div class="col-12 col-md-3 col-xl-2 bd-sidebar">
            ...
            <jsp:include page="leftside.jsp"></jsp:include>
                <main class="col-12 col-md-9 col-xl-8 py-md-3 pl-md-5 bd-content" role="main">
                    <h1 class="bd-title" id="content">排行榜</h1>
                    <form class="form-inline" action="RankServlet">
                        ...
                        <div class="container">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <%
                                        ArrayList<HomeWorkRank> ahr =(ArrayList<HomeWorkRank>) session.getAttribute("ranklist");
                                        if (ahr == null) {
                                            ahr = new ArrayList();
                                        }
                                        for (int i = 0; i < ahr.size(); i++) {
                                            HomeWorkRank hr = ahr.get(i);
